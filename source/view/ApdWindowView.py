...
################################################################################
## Form generated from reading UI file 'apdWindow.ui'
##
...
class Ui_apdWindow(object):
    def setupUi(self, apdWindow):
        if not apdWindow.objectName():
            apdWindow.setObjectName(u"apdWindow")
        apdWindow.resize(608, 566)
        apdWindow.setMinimumSize(QSize(608, 566))
        apdWindow.setMaximumSize(QSize(608, 566))
        self.centralwidget = QWidget(apdWindow)
        ...
        apdWindow.setCentralWidget(self.centralwidget)
        ...
        self.statusbar = QStatusBar(apdWindow)
        self.statusbar.setObjectName(u"statusbar")
        apdWindow.setStatusBar(self.statusbar)

        self.retranslateUi(apdWindow)

        QMetaObject.connectSlotsByName(apdWindow)
    # setupUi

    def retranslateUi(self, apdWindow):
        apdWindow.setWindowTitle(QCoreApplication.translate("apdWindow", u"Caldeir\u00e3o de Pilha Deterministico", None))
        self.aLabel.setText(QCoreApplication.translate("apdWindow", u"\u00c1gua", None))
        self.bLabel.setText(QCoreApplication.translate("apdWindow", u"Asas de Borboleta", None))
        self.aButton.setText(QCoreApplication.translate("apdWindow", u"a", None))
        self.bButton.setText(QCoreApplication.translate("apdWindow", u"b", None))
        self.dButton.setText(QCoreApplication.translate("apdWindow", u"d", None))
        self.dLabel.setText(QCoreApplication.translate("apdWindow", u"Dedos Humanos", None))
        self.mLabel.setText(QCoreApplication.translate("apdWindow", u"Asas de Morcego", None))
        self.mButton.setText(QCoreApplication.translate("apdWindow", u"m", None))
        self.oButton.setText(QCoreApplication.translate("apdWindow", u"o", None))
        self.oLabel.setText(QCoreApplication.translate("apdWindow", u"P\u00f3 de Ossos", None))
        self.pButton.setText(QCoreApplication.translate("apdWindow", u"p", None))
        self.rButton.setText(QCoreApplication.translate("apdWindow", u"r", None))
        self.vButton.setText(QCoreApplication.translate("apdWindow", u"v", None))
        self.pLabel.setText(QCoreApplication.translate("apdWindow", u"P\u00e9talas", None))
        self.rLabel.setText(QCoreApplication.translate("apdWindow", u"Rabo de Rato", None))
        self.vLabel.setText(QCoreApplication.translate("apdWindow", u"Veneno de Cobra", None))
        self.cauldronLabel.setText("")
        self.ingredientLabel.setText("")
        self.stopButton.setText(QCoreApplication.translate("apdWindow", u"Parar a Mistura", None))
    # retranslateUi
